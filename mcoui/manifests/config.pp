class mcoui::config{
  ...
  file { 'discoveryddl':
   ...
   file {"/usr/share/mcollective/plugins/mcollective/agent/rpcutil.rb":
    ensure => directory,
    require => File['discoveryddl'],
    source => "puppet:///modules/mcoui/rpcutil.rb",
  }

  file {"/usr/share/mcollective/plugins/mcollective/agent/rpcutil.ddl":
    ensure => directory,
    require => File['/usr/share/mcollective/plugins/mcollective/agent/'],
    source => "puppet:///modules/mcoui/rpcutil.ddl",
  }
